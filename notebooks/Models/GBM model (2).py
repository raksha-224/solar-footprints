...
model_path = r"GBM_pickle.pkl"
with open(model_path, 'wb') as file:
    pickle.dump(best_model, file)

print("GBM trained and saved successfully.")
...
# Get predicted probabilities (for multi-class classification)
y_prob = best_model.predict_proba(X_test)

# Compute log loss (cross-entropy loss) for the multi-class case
