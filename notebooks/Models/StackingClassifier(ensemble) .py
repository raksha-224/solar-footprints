...
from sklearn.metrics import accuracy_score,precision_recall_curve, classification_report, confusion_matrix,roc_auc_score,ConfusionMatrixDisplay,auc,roc_curve
...
# Get predicted probabilities for each class (using `predict_proba`)
y_prob = best_model.predict_proba(X_test)
...
model_path = r"stacking_pickle.pkl"
with open(model_path, 'wb') as file:
    pickle.dump(best_model, file)

print("stacking trained and saved successfully.")
